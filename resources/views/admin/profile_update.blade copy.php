...
<head>
    ...
    <script nonce="530bbcee-6027-4610-93d7-4d86f47edffc">
        try {
            (function(w, d) {
                ! function(j, k, l, m) {
                    j[l] = j[l] || {};
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="/logout" onclick="logoutUser()" class="nav-link">Logout</a>
                </li>
            </ul>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="password" id="password" class="form-control"
                                        placeholder="Enter old password" step="1">
                                </div>
                                <div class="form-group">
...
<!-- Mirrored from adminlte.io/themes/v3/pages/examples/project-edit.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 May 2024 05:17:01 GMT -->
